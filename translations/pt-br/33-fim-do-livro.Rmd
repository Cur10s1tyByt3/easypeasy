...
:   - É impossível expressar minha gratidão inacreditável que as pessoas estão dispostas a ajudarem na tradução deste livro e ajudar a liberar os outros. Você pode fazer isso através [do Gitlab](https://gitlab.com/snuggy/easypeasy) (no caso do original.
...
Caso contrário, se você está procurando algo mais curto, meu texto autoral favorito [Exiting Modernity| Somente em Inglês] (https://www.meta-nomad.net/exiting-modernity/) do Meta Nomad. Se for para você tirar qualquer coisa desta seção, essa coisa é que você deve ler este texto. Esteja avisado: é um texto desafiador, mas é uma experiência esclarecedora se você permitir que seja.
